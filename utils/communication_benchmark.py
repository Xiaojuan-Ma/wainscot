...
def main():
    ...
    tensor_sizes = [2 ** i for i in range(0, FLAGS.exponent)]
    ...
    for tensor_size in tensor_sizes:
        run_metadata_list = run_benchmark(
            ...
            tensor_size, FLAGS.from_gpu_id, FLAGS.to_gpu_id)
    ...
    # xiao: added return value
    coeffs_str_raw = '{} x + {}'.format(
        reg.coef_[0][0], reg.intercept_[0])
    coeffs_str = coeffs_str_raw[0] + ',' + coeffs_str_raw[-1].split('.')[0]
